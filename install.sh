...
wget https://raw.githubusercontent.com/czhang03/wifi_bt_auto_off/main/wifi_bt_auto_off.py > /dev/null
...
echo "To delete the program, simply delete the script `$HOME/.config/autostart/wifi_bt_auto_off.py`."
